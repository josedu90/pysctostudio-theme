...
Redux::setSection($opt_name, array(
  ...
  'fields' => array(
    ...
    array(
      'id' => 'header_sticky',
      'type' => 'button_set',
      'title' => esc_html__('Sticky Header', 'novo'),
      'options' => array(
        'true' => esc_html__('Yes', 'novo'),
        'false' => esc_html__('No', 'novo'),
      ),
  ...
  'fields' => array(
    ...
    array(
      ...
      'options' => array(
        ...
        'minified' => esc_html__('Minifield', 'novo'),
      ),
      'default' => 'minified',
    ),
  ),
...
Redux::setSection($opt_name, array(
  ...
  'fields' => array(
    ...
    array(
      'id' => 'project_image_like',
      'type' => 'button_set',
      'title' => esc_html__('Like Button', 'novo'),
      'options' => array(
        'show' => esc_html__('Show', 'novo'),
        'hide' => esc_html__('Hide', 'novo'),
      ),
